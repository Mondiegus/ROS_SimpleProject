...
"""autogenerated by genpy from wall_follow_pkg/OdomRecordActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class OdomRecordActionFeedback(genpy.Message):
  ...
  _type = "wall_follow_pkg/OdomRecordActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','wall_follow_pkg/OdomRecordFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = wall_follow_pkg.msg.OdomRecordFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = wall_follow_pkg.msg.OdomRecordFeedback()
