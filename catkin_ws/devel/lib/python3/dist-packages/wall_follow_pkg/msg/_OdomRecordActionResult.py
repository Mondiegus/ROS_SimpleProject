...
"""autogenerated by genpy from wall_follow_pkg/OdomRecordActionResult.msg. Do not edit."""
import codecs
import sys
...
class OdomRecordActionResult(genpy.Message):
  _md5sum = "d8904da825e868c26a95d272925534cd"
  _type = "wall_follow_pkg/OdomRecordActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','wall_follow_pkg/OdomRecordResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = wall_follow_pkg.msg.OdomRecordResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = wall_follow_pkg.msg.OdomRecordResult()
